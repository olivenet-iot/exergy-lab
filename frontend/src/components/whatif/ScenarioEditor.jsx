  ...
  return (
    <div className="bg-amber-50 border border-amber-200 rounded-xl p-6">
      ...
      <p className="text-sm text-amber-700 mb-4">
        Parametreleri değiştirerek alternatif senaryoları karşılaştırın.
      </p>
          ...
          return (
            ...
            >
              <div className="flex items-center justify-between mb-1">
                ...
                {isChanged && (
                  <span className="text-xs text-amber-600 font-mono tabular-nums">
      ...
      <div className="flex items-center gap-3 mt-6">
        <button
          onClick={onCompare}
          disabled={isLoading}
          className="px-4 py-2 bg-amber-500 text-white rounded-lg hover:bg-amber-600 disabled:opacity-50 font-medium transition-colors"
        >
